...
#define ARM_I2C_API_VERSION (ARM_DRIVER_VERSION_MAJOR_MINOR(2U,3U))  /* API version */
...
#define ARM_I2C_ADDRESS_10BIT           (0x0400U)    ///< 10-bit address flag
#define ARM_I2C_ADDRESS_GC              (0x8000U)    ///< General Call flag
